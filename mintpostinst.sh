...
sudo apt update
sudo apt purge --auto-remove firefox libreoffice* thunderbird onboard catfish sticky celluoid compiz* drawing hexchat hypnotix light-locker redshift* metacity* rhythmbox transmission-* warpinator sticky catfish orca
