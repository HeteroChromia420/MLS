...
sudo apt-fast install sddm smplayer cantata mpd mpv youtube-dl synaptic eject bash-completion gvfs* qt5-style-plugins plasma-nm kde-spectacle xinit pulseaudio alsa-utils ark gwenview kate xserver-xorg xdg-user-dirs wpasupplicant gimp xserver-xorg-video-intel firmware-amd-graphics fonts-noto* redshift-gtk geoclue-2.0 arc-theme kdeconnect papirus-icon-theme breeze-cursor-theme steam flatpak desktop-base kde-config-gtk-style kde-config-screenlocker kde-config-sddm khotkeys kinfocenter kmenuedit kscreen ksysguard kwin-x11 powerdevil systemsettings plasma-discover kde-plasma-desktop plasma-pa kwalletmanager qml-module-org-kde-newstuff debian-pulseaudio-config-override latte-dock qml-module-org-kde-activities kactivities-bin ungoogled-chromium ungoogled-chromium-sandbox --no-install-recommends --no-install-suggests -y
